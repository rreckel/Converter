...
object ButtonGroupProps {
  ...
  implicit class ButtonGroupPropsOps[Self <: ButtonGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBlock(block: Boolean): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("block")(block.asInstanceOf[js.Any])
    ...
    def withBsSize(bsSize: Sizes): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("bsSize")(bsSize.asInstanceOf[js.Any])
        ret.asInstanceOf[Self]
    }
    @scala.inline
    ...
    def withBsStyle(bsStyle: String): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("bsStyle")(bsStyle.asInstanceOf[js.Any])
        ret.asInstanceOf[Self]
    }
    @scala.inline
    ...
    @scala.inline
    def withJustified(justified: Boolean): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("justified")(justified.asInstanceOf[js.Any])
        ret.asInstanceOf[Self]
    }
    @scala.inline
