...
object TdHTMLAttributes {
  ...
  implicit class TdHTMLAttributesOps[Self[t] <: TdHTMLAttributes[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withValignMiddle(valign: middle): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("valign")(valign.asInstanceOf[js.Any])
        ret.asInstanceOf[Self[T]]
    }
    @scala.inline
    def withoutValign: Self[T] = {
        val ret = this.duplicate
        js.special.delete(ret, "valign")
        ret.asInstanceOf[Self[T]]
    }
    @scala.inline
    def withValignBaseline(valign: baseline): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("valign")(valign.asInstanceOf[js.Any])
        ret.asInstanceOf[Self[T]]
    }
    @scala.inline
    def withValignBottom(valign: bottom): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("valign")(valign.asInstanceOf[js.Any])
        ret.asInstanceOf[Self[T]]
    }
    @scala.inline
    def withValignTop(valign: top): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("valign")(valign.asInstanceOf[js.Any])
        ret.asInstanceOf[Self[T]]
    }
