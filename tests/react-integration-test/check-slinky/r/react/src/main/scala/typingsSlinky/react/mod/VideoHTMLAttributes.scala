...
object VideoHTMLAttributes {
  ...
  def apply[T](
    ...
    if (!js.isUndefined(disablePictureInPicture)) __obj.updateDynamic("disablePictureInPicture")(disablePictureInPicture.asInstanceOf[js.Any])
  ...
  implicit class VideoHTMLAttributesOps[Self[t] <: VideoHTMLAttributes[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withDisablePictureInPicture(disablePictureInPicture: Boolean): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("disablePictureInPicture")(disablePictureInPicture.asInstanceOf[js.Any])
