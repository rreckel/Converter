...
object ScriptHTMLAttributes {
  ...
  def apply[T](
    ...
    if (!js.isUndefined(noModule)) __obj.updateDynamic("noModule")(noModule.asInstanceOf[js.Any])
  ...
  implicit class ScriptHTMLAttributesOps[Self[t] <: ScriptHTMLAttributes[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withNoModule(noModule: Boolean): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("noModule")(noModule.asInstanceOf[js.Any])
        ret.asInstanceOf[Self[T]]
    }
    @scala.inline
    def withoutNoModule: Self[T] = {
        val ret = this.duplicate
        js.special.delete(ret, "noModule")
        ret.asInstanceOf[Self[T]]
    }
    @scala.inline
