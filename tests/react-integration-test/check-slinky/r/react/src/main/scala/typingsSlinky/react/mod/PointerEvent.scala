...
object PointerEvent {
  ...
  @scala.inline
  implicit class PointerEventOps[Self[t] <: SyntheticPointerEvent[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPointerTypePen(pointerType: pen): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("pointerType")(pointerType.asInstanceOf[js.Any])
        ret.asInstanceOf[Self[T]]
    }
    @scala.inline
    def withPointerTypeTouch(pointerType: touch): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("pointerType")(pointerType.asInstanceOf[js.Any])
        ret.asInstanceOf[Self[T]]
    }
    @scala.inline
    def withPointerTypeMouse(pointerType: mouse): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("pointerType")(pointerType.asInstanceOf[js.Any])
        ret.asInstanceOf[Self[T]]
    }
