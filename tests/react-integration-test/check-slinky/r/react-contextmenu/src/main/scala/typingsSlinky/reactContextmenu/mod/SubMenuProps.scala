...
object SubMenuProps {
  ...
  implicit class SubMenuPropsOps[Self <: SubMenuProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHoverDelayInt(hoverDelay: Int): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("hoverDelay")(hoverDelay.asInstanceOf[js.Any])
        ret.asInstanceOf[Self]
    }
    @scala.inline
    def withHoverDelayDouble(hoverDelay: Double): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("hoverDelay")(hoverDelay.asInstanceOf[js.Any])
        ret.asInstanceOf[Self]
    }
    ...
    @scala.inline
    def withPreventCloseOnClick(preventCloseOnClick: Boolean): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("preventCloseOnClick")(preventCloseOnClick.asInstanceOf[js.Any])
        ret.asInstanceOf[Self]
    }
    @scala.inline
